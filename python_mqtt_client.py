...
def on_message(client, userdata, msg):
    ...
    if value.size == 119:       # paquetes deseados
        if num_mess <=3000:     # cantidad de paquetes deseados
    ...
    if data_audio.size >= 357000:   # una vez se alcanza la cantidad de datos deseada se crea el .wav
